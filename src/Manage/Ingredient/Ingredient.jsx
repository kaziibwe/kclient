...
function Ingredient() {
    ...
    const url = `${BASE_URL}/cart/get-all/ingredient`;
    ...
    const deleteUrl = `${BASE_URL}/admin/delete/ingredient`; // The base URL for deleting categories
    ...
    <main id="main" className="main">
                ...
                <div class="card">
                    <div class="card-body"> <br />
                        <Link to={`/addingredient`} class="btn btn-primary">Add ingredient</Link>

                        <h5 class="card-title">Manage ingredient</h5>
                                    ...
                                    data.results.data.map((product, index) => (
                                        <tr key={product.id}>
                                            ...
                                            <td>
                                                ...
                                                <Link to={`/editingredient/${product.id}`} class="btn btn-success">Edit</Link>
