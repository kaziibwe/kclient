...
//     e.preventDefault()
//     setIsPending(true)
//     axios.post(`https://testapi.cognospheredynamics.com/api/v1/adminlogin`, { email, password })
//       .then(res => {
//         console.log(res)
                      ...
                      <form className="row g-3 needs-validation" noValidate onSubmit={handleSubmit}>
                        ...
                        <div className="col-12">
                          <button className="btn btn-primary w-100" type="submit">
                            {isPending ? <div className="spinner-border" role="status"><span className="visually-hidden">Loading...</span></div> : login}
                          </button>
                        </div>
                      </form>
                    </div>
